...
const VARIATION_NOTES: Record<number, string> = {
  ...
  150: "At $150, total estimated fees reach about $14.70. That's a meaningful dollar amount — and with Offsite Ads the combined bill exceeds $32.70, which can significantly compress margin on mid-to-high ticket items.",
...
const KEEP_SUMMARIES: Record<number, string> = {
  ...
  500: "After roughly $47.95 in fees, you keep about $452.05 before costs. The effective fee rate at $500 sits near 9.6% — but Offsite Ads at 12% can add $60 more, making attributed sales worth scrutinising carefully.",
