      ...
      <main className="calculator-page-bg min-h-screen py-10 sm:py-14">
        <div className="mx-auto max-w-4xl px-4 sm:px-6">
          <article className="rounded-2xl border border-white/10 bg-white/5 p-6 text-[#EAF0FF] sm:p-10">
            <h1 className="text-3xl font-semibold tracking-tight text-[#EAF0FF] sm:text-4xl">How Much You Actually Keep From a $75 Etsy Sale</h1>
            <p className="mt-5 text-base leading-7 text-[#9AA6BF]">On a $75 sale, Etsy collects listing, transaction, and payment processing fees. This page shows the fee breakdown and what you keep before product and shipping costs.</p>
            <p className="mt-3 text-base leading-7 text-[#9AA6BF]">On higher-ticket orders, fee dollars become substantial, especially when Offsite Ads applies. Pricing strategy matters more at this level.</p>

            <section className="mt-10 space-y-4">
              <h2 className="text-2xl font-semibold text-[#EAF0FF]">Fee breakdown for a $75 order</h2>
              ...
              <p className="leading-7 text-[#9AA6BF]">With Offsite Ads, fees can reach about <strong>${withOffsiteAds.toFixed(2)}</strong>, depending on your region and order details.</p>
            </section>
            ...
            <section className="mt-10 space-y-4">
              ...
              <p className="leading-7 text-[#9AA6BF]">If cost of goods is $30 and shipping $8, real profit before ads is about $29.42. Even when payout looks large, true profit can be thinner than expected after fees, shipping, and product costs.</p>
            </section>

            <section className="mt-10 space-y-4">
              <h2 className="text-2xl font-semibold text-[#EAF0FF]">What affects your profit</h2>
              <p className="leading-7 text-[#9AA6BF]">Fees may apply to shipping charged to the buyer. Payment processing rates vary by region. Offsite Ads add 12% when they drive the sale. Product costs, packaging, and your shipping cost determine what’s left.</p>
              <p className="leading-7 text-[#9AA6BF]">See how fees scale: <Link href="/etsy-fees-on-50-dollar-sale" className="font-semibold text-[#6EE7B7] underline decoration-[#6EE7B7] decoration-2 underline-offset-2">Etsy fees on a $50 sale</Link>, <Link href="/etsy-fees-on-100-dollar-sale" className="font-semibold text-[#6EE7B7] underline decoration-[#6EE7B7] decoration-2 underline-offset-2">Etsy fees on a $100 sale</Link>, or <Link href="/etsy-fees-on-150-dollar-sale" className="font-semibold text-[#6EE7B7] underline decoration-[#6EE7B7] decoration-2 underline-offset-2">Etsy fees on a $150 sale</Link>.</p>
            </section>
            ...
            <section className="mt-8 rounded-xl border border-white/10 bg-white/5 p-5 sm:p-6">
              ...
              <div className="mt-4 grid gap-3 sm:grid-cols-2">
                ...
                <Link href="/etsy-fees-on-40-dollar-sale" className="rounded-md border border-white/20 bg-white/5 px-4 py-3 text-sm font-semibold text-[#EAF0FF] transition hover:bg-white/10">
                  Etsy Fees on a $40 Sale<span className="mt-1 block text-xs font-normal text-[#9AA6BF]">Compare at a lower price point.</span>
                </Link>
              </div>
            </section>
          </article>
