      ...
      <main className="calculator-page-bg min-h-screen py-10 sm:py-14">
        <div className="mx-auto max-w-4xl px-4 sm:px-6">
          <article className="rounded-2xl border border-white/10 bg-white/5 p-6 text-[#EAF0FF] sm:p-10">
            <h1 className="text-3xl font-semibold tracking-tight text-[#EAF0FF] sm:text-4xl">How to Price Etsy Products</h1>
            ...
            <section className="mt-12 space-y-4">
              <h2 className="text-2xl font-semibold text-[#EAF0FF]">A Simple Etsy Pricing Formula</h2>
              <p className="rounded-lg bg-slate-50 px-4 py-3 font-semibold text-[#EAF0FF]">
            ...
            <section className="mt-12 space-y-4">
              <h2 className="text-2xl font-semibold text-[#EAF0FF]">Example: Pricing an Etsy Product</h2>
              <p className="leading-7 text-[#9AA6BF]">
                Example inputs:
                <br />
                Cost of goods: $8
              ...
              <p className="leading-7 text-[#9AA6BF]">
                ...
                <Link href="/etsy-break-even-calculator" className="font-semibold text-[#6EE7B7] underline decoration-[#6EE7B7] decoration-2 underline-offset-2">
            ...
            <section className="mt-8 rounded-xl border border-white/10 bg-white/5 p-5 sm:p-6">
              <p className="text-sm font-medium uppercase tracking-wide text-[#9AA6BF]">Check your pricing before listing your product</p>
              <p className="mt-2 text-sm leading-6 text-[#9AA6BF]">Run your numbers with the Etsy Profit Calculator.</p>
              <Link
                href="/etsy-profit-calculator"
            ...
            <section className="mt-12 space-y-4">
              ...
              <p className="leading-7 text-[#9AA6BF]">Yes. Shipping cost is part of your real cost and should be included when setting prices.</p>
