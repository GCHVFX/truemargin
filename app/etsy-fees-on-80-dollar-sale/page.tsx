...
export default function Page() {
  ...
  return (
    <>
      <Script id="tm-etsy-fees-80-jsonld" type="application/ld+json" strategy="afterInteractive" dangerouslySetInnerHTML={{ __html: jsonLd() }} />
      <main className="bg-[#F7F8FA] py-10 sm:py-14">
        <div className="mx-auto max-w-4xl px-4 sm:px-6">
          <article className="rounded-2xl bg-white p-6 text-slate-800 shadow-sm ring-1 ring-slate-200 sm:p-10">
            <h1 className="text-3xl font-semibold tracking-tight text-[#2F3A56] sm:text-4xl">What You Keep From an $80 Etsy Sale</h1>
            <p className="mt-5 text-base leading-7">An $80 sale attracts listing, transaction, and payment processing fees. This page shows the fee breakdown and your payout before product and shipping costs.</p>
            <p className="mt-3 text-base leading-7">At this price point, fee dollars become substantial. Pricing strategy matters more when each percentage point represents real dollars.</p>

            <section className="mt-10 space-y-4">
              <h2 className="text-2xl font-semibold text-[#2F3A56]">Fee breakdown for an $80 order</h2>
              ...
              <p className="leading-7">With Offsite Ads, fees can climb to about <strong>${withOffsiteAds.toFixed(2)}</strong>, depending on region and order details.</p>
            </section>
            ...
            <section className="mt-10 space-y-4">
              ...
              <p className="leading-7">If cost of goods is $32 and shipping $10, real profit before ads is about $29.95. Calculators help you model different COGS and shipping scenarios.</p>
            </section>

            <section className="mt-10 space-y-4">
              <h2 className="text-2xl font-semibold text-[#2F3A56]">What affects your profit</h2>
              <p className="leading-7">Shipping charged to the buyer may be subject to fees. Payment processing varies by region. Offsite Ads add 12% when they drive the sale. Product costs, packaging, and shipping determine final net earnings.</p>
              <p className="leading-7">Compare: <Link href="/etsy-fees-on-75-dollar-sale" className="font-semibold text-[#2F3A56] underline decoration-[#F4A261] decoration-2 underline-offset-2">Etsy fees on a $75 sale</Link>, <Link href="/etsy-fees-on-100-dollar-sale" className="font-semibold text-[#2F3A56] underline decoration-[#F4A261] decoration-2 underline-offset-2">Etsy fees on a $100 sale</Link>, or <Link href="/etsy-fees-on-120-dollar-sale" className="font-semibold text-[#2F3A56] underline decoration-[#F4A261] decoration-2 underline-offset-2">what Etsy takes from a $120 sale</Link>.</p>
            </section>
            ...
            <section className="mt-8 rounded-xl border border-[#F4A261]/35 bg-[#F4A261]/10 p-5 sm:p-6">
              ...
              <div className="mt-4 grid gap-3 sm:grid-cols-2">
                ...
                <Link href="/etsy-fees-on-60-dollar-sale" className="rounded-md border border-[#2F3A56] bg-white px-4 py-3 text-sm font-semibold text-[#2F3A56] transition hover:bg-slate-50">
                  Etsy Fees on a $60 Sale<span className="mt-1 block text-xs font-normal text-slate-600">Compare at lower price.</span>
                </Link>
