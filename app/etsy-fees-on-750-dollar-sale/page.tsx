...
export default function Page() {
  ...
  return (
    <>
      <Script id="tm-etsy-fees-750-jsonld" type="application/ld+json" strategy="afterInteractive" dangerouslySetInnerHTML={{ __html: jsonLd() }} />
      <main className="bg-[#F7F8FA] py-10 sm:py-14">
        <div className="mx-auto max-w-4xl px-4 sm:px-6">
          <article className="rounded-2xl bg-white p-6 text-slate-800 shadow-sm ring-1 ring-slate-200 sm:p-10">
            <h1 className="text-3xl font-semibold tracking-tight text-[#2F3A56] sm:text-4xl">Etsy Fee Breakdown for a $750 Item</h1>
            <p className="mt-5 text-base leading-7">When you sell for $750, Etsy applies listing, transaction, and payment processing fees. This page shows the fee breakdown and your payout before product and shipping costs.</p>
            <p className="mt-3 text-base leading-7">On high-ticket orders, fee dollars can exceed $70 before Offsite Ads. Pricing with margin in mind is critical at this level.</p>

            <section className="mt-10 space-y-4">
              <h2 className="text-2xl font-semibold text-[#2F3A56]">Fee breakdown for a $750 order</h2>
              ...
              <p className="leading-7">With Offsite Ads, total fees can rise to roughly <strong>${withOffsiteAds.toFixed(2)}</strong>, depending on region and order details.</p>
            </section>
            ...
            <section className="mt-10 space-y-4">
              ...
              <p className="leading-7">If cost of goods is $300 and shipping $35, real profit before ads is roughly $343.30. A calculator helps you model different COGS and shipping scenarios for high-value items.</p>
            </section>

            <section className="mt-10 space-y-4">
              <h2 className="text-2xl font-semibold text-[#2F3A56]">What affects your profit</h2>
              <p className="leading-7">Shipping charged to the buyer may be subject to fees. Payment processing varies by region. Offsite Ads add 12% when they drive the sale. Product costs, packaging, and your shipping cost determine final take-home.</p>
              <p className="leading-7">See <Link href="/etsy-fees-on-500-dollar-sale" className="font-semibold text-[#2F3A56] underline decoration-[#F4A261] decoration-2 underline-offset-2">Etsy fees on a $500 sale</Link>, <Link href="/etsy-fees-on-400-dollar-sale" className="font-semibold text-[#2F3A56] underline decoration-[#F4A261] decoration-2 underline-offset-2">what you keep from a $400 Etsy sale</Link>, or <Link href="/etsy-fees-on-300-dollar-sale" className="font-semibold text-[#2F3A56] underline decoration-[#F4A261] decoration-2 underline-offset-2">Etsy fees on a $300 sale</Link>.</p>
            </section>
