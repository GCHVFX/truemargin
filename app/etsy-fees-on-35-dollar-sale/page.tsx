      ...
      <main className="calculator-page-bg min-h-screen py-10 sm:py-14">
        <div className="mx-auto max-w-4xl px-4 sm:px-6">
          <article className="rounded-2xl border border-white/10 bg-white/5 p-6 text-[#EAF0FF] sm:p-10">
            <h1 className="text-3xl font-semibold tracking-tight text-[#EAF0FF] sm:text-4xl">How Much You Keep From a $35 Etsy Sale</h1>
            <p className="mt-5 text-base leading-7 text-[#9AA6BF]">A $35 sale generates listing, transaction, and payment processing fees. This breakdown shows what Etsy takes and what you retain before product and shipping costs.</p>
            <p className="mt-3 text-base leading-7 text-[#9AA6BF]">At this price, fee dollars climb with order value. Small pricing adjustments can meaningfully change take-home profit.</p>

            <section className="mt-10 space-y-4">
              <h2 className="text-2xl font-semibold text-[#EAF0FF]">Fee breakdown for a $35 order</h2>
            ...
            <section className="mt-10 space-y-4">
              ...
              <p className="leading-7 text-[#9AA6BF]">Before your costs, you keep around <strong>${keepBeforeCosts.toFixed(2)}</strong> after baseline Etsy fees. With Offsite Ads, that becomes roughly <strong>${keepWithOffsite.toFixed(2)}</strong>.</p>
              <p className="leading-7 text-[#9AA6BF]">If cost of goods is $14 and shipping $5, real profit before ads is about $12.22. A calculator lets you model different scenarios.</p>
            </section>

            <section className="mt-10 space-y-4">
              <h2 className="text-2xl font-semibold text-[#EAF0FF]">What affects your profit</h2>
              <p className="leading-7 text-[#9AA6BF]">Shipping charged to the buyer can be subject to fees. Payment processing varies by region. Offsite Ads add 12% when they drive the sale. Product costs, packaging, and shipping determine final net earnings.</p>
              <p className="leading-7 text-[#9AA6BF]">Compare: <Link href="/etsy-fees-on-30-dollar-sale" className="font-semibold text-[#6EE7B7] underline decoration-[#6EE7B7] decoration-2 underline-offset-2">Etsy fees on a $30 sale</Link>, <Link href="/etsy-fees-on-40-dollar-sale" className="font-semibold text-[#6EE7B7] underline decoration-[#6EE7B7] decoration-2 underline-offset-2">what Etsy takes from a $40 sale</Link>, <Link href="/etsy-fees-on-50-dollar-sale" className="font-semibold text-[#6EE7B7] underline decoration-[#6EE7B7] decoration-2 underline-offset-2">Etsy fees on a $50 sale</Link>, or <Link href="/etsy-fees-on-60-dollar-sale" className="font-semibold text-[#6EE7B7] underline decoration-[#6EE7B7] decoration-2 underline-offset-2">Etsy fee breakdown for a $60 item</Link>.</p>
            </section>
            ...
            <section className="mt-8 rounded-xl border border-white/10 bg-white/5 p-5 sm:p-6">
              ...
              <div className="mt-4 grid gap-3 sm:grid-cols-2">
                ...
                <Link href="/etsy-fees-on-25-dollar-sale" className="rounded-md border border-white/20 bg-white/5 px-4 py-3 text-sm font-semibold text-[#EAF0FF] transition hover:bg-white/10">
                  Etsy Fees on a $25 Sale<span className="mt-1 block text-xs font-normal text-[#9AA6BF]">Compare at lower price.</span>
                </Link>
              </div>
            </section>
          </article>
