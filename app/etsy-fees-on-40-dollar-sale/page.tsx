      ...
      <main className="calculator-page-bg min-h-screen py-10 sm:py-14">
        <div className="mx-auto max-w-4xl px-4 sm:px-6">
          <article className="rounded-2xl border border-white/10 bg-white/5 p-6 text-[#EAF0FF] sm:p-10">
            <h1 className="text-3xl font-semibold tracking-tight text-[#EAF0FF] sm:text-4xl">What Etsy Takes From a $40 Sale</h1>
            <p className="mt-5 text-base leading-7 text-[#9AA6BF]">Selling an item for $40 means Etsy applies listing, transaction, and payment processing fees. This page explains the fee structure and what you keep before product and shipping costs.</p>
            <p className="mt-3 text-base leading-7 text-[#9AA6BF]">The payout can still look healthy before costs, but real profit depends heavily on cost of goods and shipping. Fee clarity helps you price with margin in mind.</p>

            <section className="mt-10 space-y-4">
              <h2 className="text-2xl font-semibold text-[#EAF0FF]">Fee breakdown for a $40 order</h2>
              ...
              <p className="leading-7 text-[#9AA6BF]">If Offsite Ads applies, total fees can reach about <strong>${withOffsiteAds.toFixed(2)}</strong>, depending on your region and order details.</p>
            </section>

            <section className="mt-10 space-y-4">
              <h2 className="text-2xl font-semibold text-[#EAF0FF]">Real profit example</h2>
              <p className="leading-7 text-[#9AA6BF]">Before your costs, you keep approximately <strong>${keepBeforeCosts.toFixed(2)}</strong> after baseline Etsy fees. With Offsite Ads, that becomes about <strong>${keepWithOffsite.toFixed(2)}</strong>.</p>
              <p className="leading-7 text-[#9AA6BF]">If cost of goods is $15 and shipping $6, real profit before ads is around $14.75. A calculator lets you model different COGS and shipping scenarios.</p>
            </section>

            <section className="mt-10 space-y-4">
              <h2 className="text-2xl font-semibold text-[#EAF0FF]">What affects your profit</h2>
              <p className="leading-7 text-[#9AA6BF]">Shipping charged to the buyer may be subject to fees. Payment processing varies by region. Offsite Ads add 12% when they drive the sale. Product costs, packaging, and your shipping cost determine final profit.</p>
              <p className="leading-7 text-[#9AA6BF]">Compare with <Link href="/etsy-fees-on-30-dollar-sale" className="font-semibold text-[#6EE7B7] underline decoration-[#6EE7B7] decoration-2 underline-offset-2">Etsy fees on a $30 sale</Link>, <Link href="/etsy-fees-on-50-dollar-sale" className="font-semibold text-[#6EE7B7] underline decoration-[#6EE7B7] decoration-2 underline-offset-2">Etsy fees on a $50 sale</Link>, or <Link href="/etsy-fees-on-75-dollar-sale" className="font-semibold text-[#6EE7B7] underline decoration-[#6EE7B7] decoration-2 underline-offset-2">Etsy fees on a $75 sale</Link>.</p>
            </section>
            ...
            <section className="mt-8 rounded-xl border border-white/10 bg-white/5 p-5 sm:p-6">
              ...
              <div className="mt-4 grid gap-3 sm:grid-cols-2">
                ...
                <Link href="/etsy-fees-on-25-dollar-sale" className="rounded-md border border-white/20 bg-white/5 px-4 py-3 text-sm font-semibold text-[#EAF0FF] transition hover:bg-white/10">
                  Etsy Fees on a $25 Sale<span className="mt-1 block text-xs font-normal text-[#9AA6BF]">Compare at a lower price point.</span>
                </Link>
              </div>
            </section>
          </article>
