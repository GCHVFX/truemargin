...
export default function Page() {
  ...
  return (
    <>
      <Script id="tm-etsy-fees-12-jsonld" type="application/ld+json" strategy="afterInteractive" dangerouslySetInnerHTML={{ __html: jsonLd() }} />
      <main className="bg-[#F7F8FA] py-10 sm:py-14">
        <div className="mx-auto max-w-4xl px-4 sm:px-6">
          <article className="rounded-2xl bg-white p-6 text-slate-800 shadow-sm ring-1 ring-slate-200 sm:p-10">
            <h1 className="text-3xl font-semibold tracking-tight text-[#2F3A56] sm:text-4xl">What Etsy Takes From a $12 Sale</h1>
            <p className="mt-5 text-base leading-7">Selling for $12 means Etsy applies listing, transaction, and payment processing fees. This page shows the fee breakdown and your net earnings before product and shipping costs.</p>
            <p className="mt-3 text-base leading-7">At low price points, fixed fees eat a larger share of the sale. Margin tightens quickly once you add cost of goods and shipping.</p>

            <section className="mt-10 space-y-4">
              <h2 className="text-2xl font-semibold text-[#2F3A56]">Fee breakdown for a $12 order</h2>
            ...
            <section className="mt-10 space-y-4">
              ...
              <p className="leading-7">Before your costs, you keep roughly <strong>${keepBeforeCosts.toFixed(2)}</strong> after baseline Etsy fees. With Offsite Ads, that drops to about <strong>${keepWithOffsite.toFixed(2)}</strong>.</p>
              <p className="leading-7">Example: $4 cost of goods and $2 shipping leaves around $4.41 in real profit before ads. Use a calculator to model your own numbers.</p>
            </section>

            <section className="mt-10 space-y-4">
              <h2 className="text-2xl font-semibold text-[#2F3A56]">What affects your profit</h2>
              <p className="leading-7">Shipping charged to the buyer may be subject to fees. Payment processing varies by region. Offsite Ads add 12% when they drive the sale. Product costs and shipping eat into the remainder.</p>
              <p className="leading-7">Compare: <Link href="/etsy-fees-on-10-dollar-sale" className="font-semibold text-[#2F3A56] underline decoration-[#F4A261] decoration-2 underline-offset-2">Etsy fees on a $10 sale</Link>, <Link href="/etsy-fees-on-15-dollar-sale" className="font-semibold text-[#2F3A56] underline decoration-[#F4A261] decoration-2 underline-offset-2">what Etsy takes from a $15 sale</Link>, or <Link href="/etsy-fees-on-20-dollar-sale" className="font-semibold text-[#2F3A56] underline decoration-[#F4A261] decoration-2 underline-offset-2">Etsy fee breakdown for a $20 item</Link>.</p>
            </section>
